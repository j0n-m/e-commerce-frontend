...
function Footer() {
  return (
    <footer className="px-8 py-14 bg-gray-800 text-neutral-100">
      <div className="footer-content flex justify-evenly border-b border-neutral-500 pb-10">
        ...
        <div className="contact">
          ...
          <div className="brand-logos flex gap-2 items-center justify-evenly mt-2">
      ...
      <div className="me flex justify-around py-6 text-sm text-neutral-400">
        <p>Cyber Den is a made up website.</p>
